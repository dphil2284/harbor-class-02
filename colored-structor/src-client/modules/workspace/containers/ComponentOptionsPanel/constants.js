...
export const styleGroups = [
  ...
  },
  {
    ...
    styles: [
      ...
      {
        path: 'style.overflowX',
        type: 'select',
        value: 'auto',
        options: ['visible', 'hidden', 'scroll', 'auto'],
      },
      {
        path: 'style.overflowY',
        type: 'select',
        value: 'auto',
        options: ['visible', 'hidden', 'scroll', 'auto'],
      },
  ...
  },
  {
    ...
    styles: [
      ...
      { path: 'style.fontFamily', type: 'text', value: '' },
      ...
      { path: 'style.letterSpacing', type: 'size', value: '0px' },
  ...
  },
  {
    ...
    styles: [
      ...
      { path: 'style.zIndex', type: 'number', value: 0 },
      {
        ...
        type: 'select',
        value: 'none',
        options: ['left', 'right', 'inline-start', 'inline-end', 'none'],
      },
    ],
  },
  {
    ...
    styles: [
      ...
      {
        path: 'style.whiteSpace',
        type: 'select',
        value: 'normal',
        options: ['normal', 'nowrap', 'pre', 'justify', 'pre-wrap', 'pre-line'],
      },
      { path: 'style.letterSpacing', type: 'size', value: '1px' },
      {
        ...
        type: 'select',
        value: 'none',
        options: ['capitalize', 'uppercase', 'lowercase', 'none', 'full-width'],
      },
      {
        path: 'style.textDecoration',
        type: 'select',
        value: 'none',
        options: ['none', 'underline red', 'underline wavy red'],
      },
      {
        path: 'style.wordBreak',
        type: 'select',
        value: 'normal',
    ...
    styles: [
      {
        ...
        type: 'select',
        value: 'solid',
        options: ['solid', 'dashed', 'dotted', 'double', 'hidden', 'none'],
      },
