...
const getValueOfProperty = propertyValue => {
  ...
  return propertyValue // Don't make text to number
}
...
class StyleTextInput extends Component {
  constructor(props) {
    super(props)
      ...
      <div style={this.props.style}>
        <div style={rowContainerStyle}>
          ...
          <div style={{ flexGrow: 0 }}>
            <i
              className={
                'fa text-muted ' + (isFavorite ? 'fa-heart' : 'fa-heart-o')
              }
